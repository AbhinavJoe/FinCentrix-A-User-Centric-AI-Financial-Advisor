        ...
        <main className='text-black h-screen flex justify-center w-full pt-20 px-10' >
            ...
            <div className='flex flex-col gap-8 border-4 border-black rounded-lg px-4 py-4 h-fit md:w-[700px]'>
                <div className='flex flex-col gap-4'>
                    <h1 className='font-semibold text-2xl'>Disclaimer</h1>
                ...
                <div onClick={handleCheckBox} className='flex gap-2 items-center hover:cursor-pointer'>
                    ...
                    <div className={`${checkbox ? "text-green-700" : null} text-base`} >I Agree to the Terms and Conditions of FinCentrix</div>
                </div>
            </div>
        </main>
    )
