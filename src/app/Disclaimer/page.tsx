    ...
    return (
        <main className='text-[#e4e4e0] h-screen flex justify-center w-full pt-20 px-10'>
            ...
            <div className='flex flex-col gap-4'>
                <div className='md:text-4xl text-2xl whitespace-break-spaces font-semibold text-[#da7756]/70'>
                    Welcome, {username?.toUpperCase()}!
                </div>
                <div className='flex flex-col md:gap-8 gap-4 border-2 border-[#43443f] rounded-lg px-4 py-4 h-fit md:w-[700px] bg-[#393937]/60'>
                    ...
                    <div onClick={handleCheckBox} className='flex gap-2 items-center hover:cursor-pointer'>
                        {
                            checkbox ? <ImCheckboxChecked className='text-[#da7756] md:text-base text-sm' /> : <ImCheckboxUnchecked className='md:text-base text-sm' />
                        }
                        <div className={`${checkbox ? "text-[#da7756]" : null} font-semibold md:text-base text-sm`} >I Agree to the Terms and Conditions of FinCentrix</div>
                    </div>
                </div>
            </div>
        </main>
